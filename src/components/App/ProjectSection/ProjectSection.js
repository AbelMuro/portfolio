...
function ProjectSection () {
    return(
        <section className={styles.container} id="projects">
            ...
            <Project href="https://dev-jobs-app-front-end.netlify.app/" src={images["devJobsApp"]} projectTitle="Dev Jobs App"/>
            <Project href="https://link-sharing-app-eight.vercel.app/" src={images["linkSharingApp"]} projectTitle="Link Sharing App"/>
