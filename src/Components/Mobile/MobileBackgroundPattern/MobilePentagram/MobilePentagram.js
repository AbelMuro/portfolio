            ...
            <svg className={styles.svg} viewBox={"0 0 206.40488 206.40488"}>
                ...
                <g className={styles.group}>       
                        ...
                        <circle 
                            ...
                            strokeOpacity={1}
                            />
                        <TechIcon name={'react'} x={149.8} y={103.5} size={'2'} scrollThresholds={[1200, 1300]}/>
                        <circle 
                            id="path697"
                            cx={150.71886}
                            cy={104.37801}
                            ...
                            strokeOpacity={1}
                            />
                        <TechIcon name={'node'} x={158.61783 - 1.1} y={107.42867 - 1} size={'2.3'} scrollThresholds={[1500, 1600]}/>
                        <circle
                            id="path702"
                            cx={158.61783}
                            cy={107.42867}
                            ...
                            strokeOpacity={1}
                            />
                        <TechIcon name={'express'} x={161.7774 - 1.4} y={114.64666 - 1.5} size={'3.1'} scrollThresholds={[1800, 1900]}/>    
                        <circle 
                            id="path696"
                            cx={161.7774}
                            cy={114.64666}
                            ...
                            strokeOpacity={1}
                            />              
                        <TechIcon name={'vue'} x={159.01715 - 1.1} y={122.11411 - 1.2} size={'2.3'} scrollThresholds={[2100, 2200]}/>                         
                        <circle 
                            id="path700-2"
                            cx={159.01715}
                            cy={122.11411}
                            ...
                            strokeOpacity={1}
                            />
                        <TechIcon name={'mySQL'} x={151.39981 - 1.4} y={125.92314 - 1.4} size={'3.1'} scrollThresholds={[2400, 2500]}/>
                        <circle 
                            id="path701"
                            cx={151.39981}
                            cy={125.92314}
                            ...
                            strokeOpacity={1}
                            />
                        <TechIcon name={'next'} x={142.73816 - 1.5} y={122.13708 - 1.7} size={'3.3'} scrollThresholds={[2700, 2800]}/>
                        <circle 
                            id="path700"
                            cx={142.73816}
                            cy={122.13708}
                            ...
                            strokeOpacity={1}
                            />
                        <TechIcon name={'mongoDB'} x={140.04163 - 2.3} y={114.70116 - 2} size={'4'} scrollThresholds={[3000, 3100]}/>
                        <circle 
                            id="path699"
                            cx={140.04163}
                            cy={114.70116}
                            ...
                            strokeOpacity={1}
                            />
                        <TechIcon name={'framermotion'} x={143.03781 - 1.65} y={107.51036 - 1.6} size={'3.5'} scrollThresholds={[3300, 3400]}/>                            
                        <circle 
                            id="path698"
                            cx={143.03781}
                            cy={107.51036}
