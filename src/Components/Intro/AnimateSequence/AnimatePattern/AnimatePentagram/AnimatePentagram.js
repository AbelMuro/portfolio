...
function AnimatePentagram({scrollThresholds, scaleThresholds}) {
    ...
    const scrollRange = [scrollThresholds[1], scrollThresholds[1] + 0.10, scrollThresholds[1] + 0.20, scrollThresholds[1] + 0.30];
    const rotate3DForY = useTransform(scrollYProgress, scrollRange, [0, -35, 0, -35])
    const rotate3DForX = useTransform(scrollYProgress, scrollRange, [0, 35, 0, -25])
    const rotateY = useTransform(rotate3DForY, (value) => `${value}deg`);
    const rotateX = useTransform(rotate3DForX, (value) => `${value}deg`);
    

    return( 
            <motion.g style={{rotateY, rotateX, scale}} className={styles.pentagram}>      
                    <g transform="translate(-74.1383963,-25.048764)">     
                        <AnimateCircles/>                        
                        <Circle
                            cx="151.34041"
                            cy="106.16869"
                        ...
                        <TechIcon name={'express'} x={144.82152 - 0.9} y={105.88365 - 0.9} size={'2'} scrollThresholds={[0.67, 0.68]}>
                            <Circle
                                cx="144.82152"
                                cy="105.88365"
                                r="1" 
