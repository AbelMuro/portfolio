...
function AnimatePentagram({scrollThresholds = [0.09, 0.21]}) {
    ...
    const viewBox = useViewBoxZoom([0.12, 0.27], 1, 3.4, MainContainerRef)
    ...
    return(    
        <svg id='pentagram' className={styles.container} viewBox={viewBox}>
                <defs>
                ...
                <motion.g style={{rotateY: rotate3DSpringY, rotateX: rotate3DSpringX, x, y}}>   
                        <AnimateCircles/>                        
